"""Comprehensive API endpoint tests for nes2 (TDD - Red Phase).
...
class TestEntityEndpoints:
    ...
    async def test_filter_entities_by_subtype(self, client):
        ...
        response = await client.get("/api/entities?entity_type=organization&sub_type=political_party")
    ...
    async def test_filter_entities_by_attributes(self, client):
        ...
        response = await client.get("/api/entities?attributes={\"party\":\"nepali-congress\"}")
...
class TestRelationshipEndpoints:
    ...
    async def test_get_entity_relationships(self, client):
        ...
        response = await client.get("/api/entities/entity:person/ram-chandra-poudel/relationships")
    ...
    async def test_search_relationships_by_target(self, client):
        ...
        assert data["total"] >= 2  # Ram Poudel and Sher Deuba
        for rel in data["relationships"]:
            assert rel["target_entity_id"] == "entity:organization/political_party/nepali-congress"
    ...
    async def test_relationship_pagination(self, client):
        ...
        response = await client.get(
            "/api/relationships?limit=1&offset=0"
        )
...
class TestVersionEndpoints:
    ...
    async def test_get_entity_versions(self, client):
        ...
        response = await client.get("/api/entities/entity:person/ram-chandra-poudel/versions")
    ...
    async def test_get_relationship_versions(self, client):
        ...
        rel_response = await client.get("/api/entities/entity:person/ram-chandra-poudel/relationships")
...
class TestSearchFunctionality:
    ...
    async def test_combined_filters(self, client):
        ...
        response = await client.get(
            "/api/entities?query=deuba&entity_type=person"
        )
