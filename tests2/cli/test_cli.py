...
class TestCLIFoundation:
    ...
    def test_cli_main_command_exists(self, runner):
        ...
        assert 'Nepal Entity Service' in result.output or 'nes2' in result.output
...
class TestSearchCommands:
    ...
    @patch('nes2.config.Config.get_search_service')
    @patch('nes2.config.Config.initialize_database')
    def test_search_entities_command(self, mock_init_db, mock_get_service, runner, mock_search_service):
        ...
        mock_entity = Person(
            ...
            names=[Name(
                ...
                en=NameParts(full="Ram Chandra Poudel")
            )],
        ...
        assert result.exit_code == 0
        assert 'ram-chandra-poudel' in result.output or 'Ram Chandra Poudel' in result.output

    @patch('nes2.config.Config.get_search_service')
    @patch('nes2.config.Config.initialize_database')
    def test_search_entities_with_type_filter(self, mock_init_db, mock_get_service, runner, mock_search_service):
    ...
    @patch('nes2.config.Config.get_search_service')
    @patch('nes2.config.Config.initialize_database')
    def test_search_entities_with_limit(self, mock_init_db, mock_get_service, runner, mock_search_service):
    ...
    @patch('nes2.config.Config.get_search_service')
    @patch('nes2.config.Config.initialize_database')
    def test_search_relationships_command(self, mock_init_db, mock_get_service, runner, mock_search_service):
    ...
    @patch('nes2.config.Config.get_database')
    @patch('nes2.config.Config.initialize_database')
    def test_show_entity_command(self, mock_init_db, mock_get_db, runner, mock_database):
...
class TestScrapingCommands:
    ...
    @patch('nes2.cli.ScrapingService')
...
class TestDataManagementCommands:
    ...
    @patch('nes2.cli.Config.get_publication_service')
    @patch('builtins.open', create=True)
    def test_data_import_command(self, mock_open, mock_get_service, runner, mock_publication_service):
    ...
    @patch('nes2.cli.Config.get_search_service')
    ...
    @patch('nes2.cli.Config.get_database')
...
class TestCLIErrorHandling:
    ...
    @patch('nes2.config.Config.get_database')
    @patch('nes2.config.Config.initialize_database')
    def test_show_nonexistent_entity_shows_error(self, mock_init_db, mock_get_db, runner, mock_database):
...
class TestCLIOutputFormatting:
    ...
    @patch('nes2.config.Config.get_search_service')
    @patch('nes2.config.Config.initialize_database')
    def test_search_output_is_readable(self, mock_init_db, mock_get_service, runner, mock_search_service):
    ...
    @patch('nes2.config.Config.get_database')
    @patch('nes2.config.Config.initialize_database')
    def test_show_output_includes_json_option(self, mock_init_db, mock_get_db, runner, mock_database):
