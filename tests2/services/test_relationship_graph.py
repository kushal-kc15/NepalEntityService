"""Tests for Relationship Graph Traversal in nes2.
...
class TestBidirectionalTraversal:
    ...
    async def test_traverse_outgoing_relationships(self, temp_db_path):
        ...
        from nes2.services.publication.graph import traverse_relationships
...
class TestRelationshipPathFinding:
    ...
    async def test_find_direct_path(self, temp_db_path):
        ...
        from nes2.services.publication import PublicationService
        from nes2.services.publication.graph import find_path
...
class TestGraphVisualization:
    ...
    async def test_generate_dot_format(self, temp_db_path):
        ...
        from nes2.services.publication import PublicationService
        from nes2.services.publication.graph import generate_graph_visualization
