"""Tests for Relationship Integrity in nes2.
...
class TestCircularRelationshipDetection:
    ...
    async def test_detect_direct_circular_relationship(self, temp_db_path):
        ...
        from nes2.services.publication import PublicationService
        from nes2.services.publication.integrity import check_circular_relationship
...
class TestConstraintValidation:
    ...
    async def test_validate_duplicate_relationships(self, temp_db_path):
        ...
        from nes2.services.publication import PublicationService
        from nes2.services.publication.integrity import check_duplicate_relationship
